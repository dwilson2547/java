...
public class MyCLIParserTest extends TestCase {
    ...
    public void testAdd_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-add", "Cat"});
    ...
    public void testSub_01() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-sub", "4"});
        assertTrue(outContent.toString().matches("Argument count mismatch\\r?\\n"));
    }
    ...
    public void testSub_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-sub", "4", "cat"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testMul_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-mul", "3", "3", "3"});
        assertTrue(outContent.toString().matches("27\\r?\\n"));
    }
    ...
    public void testMul_01() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-mul", "3"});
    ...
    public void testMul_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-mul", "cat"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testDiv_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "9", "3"});
        assertTrue(outContent.toString().matches("3.00\\r?\\n"));
    }
    ...
    public void testDiv_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "3", "cat"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testDiv_04() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "4", "0"});
    ...
    public void testStats_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-stats", "cat"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testTable_02() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-table", "cat"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
